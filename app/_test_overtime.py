...
# Eksempel 1: kl. 4-14 (10t) -> normal=10, foer=1, ot13=1, oevrig=1
# Nattimer (04-05) og førtimer (05-06) giver normal løn + tillæg, men fortærer
# IKKE det registrerede normaltids-loft (kun 06-18 gør) – rettet 2026-07-02,
# se docs/OVERTIME_RULES.md
check("Eksempel 1", datetime(2026, 6, 8, 4), datetime(2026, 6, 8, 14), (1, 10, 1, 1))
...
D = datetime
# Pause i normal-tidsrummet: 4-14 m. pause 12:00-12:30 -> ot13=0.5, normal=9.5
check_p("Pause 06-18 ", D(2026,6,8,4), D(2026,6,8,14), [(D(2026,6,8,12), D(2026,6,8,12,30))], (1, "9.5", "0.5", 1))
...
# Pause kl. 05-06: 5-13 m. pause 05:30-05:45 -> foer=0.75, normal=7.75, ot13=0
check_p("Pause 05-06 ", D(2026,6,8,5), D(2026,6,8,13), [(D(2026,6,8,5,30), D(2026,6,8,5,45))], ("0.75", "7.75", 0, 0))
